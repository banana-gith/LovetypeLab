...
function expansionCharacterDesign({
  playerPromise,
  coreTension,
  winningMindset,
  temptationTrap,
...
export const characterGameDesign = {
  mina: {
    ...
    reviewVoice: {
      praise: "静かに刺さっています。ミナが差し出す前の言葉まで待てたのは強い。",
      miss: "雑です。ミナの沈黙を空白扱いした時点で、深い話の扉は半分閉じています。",
      pushy: "踏み込み方が荒い。深さを求めたのではなく、開示を急かしただけに見えます。",
      repair: "戻り方は悪くないです。完璧な返しより、言葉を扱い直した姿勢が残ります。",
      final: "ミナ相手に勝つなら、優しさだけでは足りません。待つことと、自分の本音を置くことの両方が必要です。",
    },
    psychologicalSwitches: [
      {
        label: "沈黙の安全",
  ...
  rio: {
    ...
    reviewVoice: {
      praise: "いいです。リオの勢いを止めずに、ちゃんと大事にする方向へ乗れています。",
      miss: "冷めます。正しさを先に出すと、リオの楽しさはあなたの前では出しにくくなります。",
      pushy: "重い。自由を好きな人に、確認や期待を前のめりに置くと一気に逃げ道を探されます。",
      repair: "取り返せています。笑い直せる余白を作れたなら、リオはまだ会話を投げてくれます。",
      final: "リオ相手はノリだけでも誠実さだけでも浅い。跳ねたあとに約束へ着地できたかが勝負です。",
    },
    psychologicalSwitches: [
      {
        label: "ひらめきの共犯",
  ...
  nagi: {
    ...
    reviewVoice: {
      praise: "届いています。ナギの曖昧な好きを、説明不足ではなく大切な感覚として扱えました。",
      miss: "浅いです。作品や理想を外側から評価した瞬間、ナギは次に見せる量を減らします。",
      pushy: "欲張りすぎです。全部知りたいは好意ではなく、ナギから見ると主導権の回収です。",
      repair: "言葉の順番を直せています。ナギには、その遅れてきた丁寧さがちゃんと効きます。",
      final: "ナギ相手は守るだけでは進みません。夢を笑わず、明日の小さな約束に置けたかが核心です。",
    },
    psychologicalSwitches: [
      {
        label: "曖昧な好きの保護",
  ...
  aoi: {
    ...
    reviewVoice: {
      praise: "かなり良いです。アオイの保留を逃げではなく、考える余白として扱えています。",
      miss: "早計です。今すぐ意味を決めようとすると、アオイは感情ごと観察対象にされたと感じます。",
      pushy: "詰め方が雑です。好きかどうかを仕様確認みたいに迫ると、恋愛温度は下がります。",
      repair: "順番を戻せています。分析より先に近くに戻ったことが、アオイにはちゃんと残ります。",
      final: "アオイ相手は正解を出すゲームではありません。考える自由を守りつつ、最後だけ短く言い切れるかです。",
    },
    psychologicalSwitches: [
      {
        label: "思考の自由",
  ...
  haruka: {
    ...
    reviewVoice: {
      praise: "堅実に刺さっています。ハルカには、気分より準備と継続が見える言葉が効きます。",
      miss: "信用を削っています。曖昧さは自由ではなく、ハルカには責任感の不足として映ります。",
      pushy: "急すぎます。段取りを飛ばして距離だけ詰めると、信頼より不安が先に来ます。",
      repair: "整え直せています。候補・理由・代案が見えると、ハルカはもう一度判断できます。",
      final: "ハルカ相手は誠実なだけでは友達止まりです。具体性の上に、控えめな甘さを乗せられたかが勝負です。",
    },
    psychologicalSwitches: [
      {
        label: "約束の見える化",
  ...
  yu: {
    ...
    reviewVoice: {
      praise: "いいテンポです。ユウには長い説明より、一緒に動ける返しが残ります。",
      miss: "止めています。考えすぎた言葉で足を止めると、ユウの恋愛温度は一段落ちます。",
      pushy: "押し方が重いです。勢いと圧は別物で、今のは相手の身体感覚を置いていっています。",
      repair: "戻せています。短く受け取り直して動ける提案に戻すと、ユウは会話に戻りやすいです。",
      final: "ユウ相手は軽快さだけでは足りません。動きながら本音を一文だけ逃がさないことが重要です。",
    },
    psychologicalSwitches: [
      {
        label: "体験で近づく",
  ...
  reina: {
    ...
    reviewVoice: {
      praise: "悪くない、というより強いです。レイナに対して明確さと敬意を同時に出せています。",
      miss: "甘いです。曖昧な共感や受け身の返事は、レイナには判断保留ではなく覚悟不足に見えます。",
      pushy: "主導権を取り違えています。強く出ることと、対等に向き合うことは違います。",
      repair: "立て直せています。正論で押さず、彼女が飲み込んだ感情まで見たのは効きます。",
      final: "レイナ相手は、優しいだけなら即アウト寄りです。明確さ、敬意、感情の扱いを同時に出してください。",
    },
    psychologicalSwitches: [
      {
        label: "対等な意思",
  ...
  sana: {
    sourceNote: sharedSourceNote,
    playerPromise: "感性を説明させず、一緒に味わうことで距離が近づく恋。",
    coreTension: "好きなものを見てほしい。でも、評価や正解で裁かれるのは怖い。",
    winningMindset: "好みを分析せず、まず同じ空気を味わい、選ぶ自由を残す。",
    temptationTrap: "センスの評価、急な結論、よかれと思った改善案の押しつけ。",
    mastery: "サナの感性を正解化せず、親密さと自由を同時に守れるようになった。",
    visualFormula: "花屋、夕方の公園、淡いピンク、手元、影のやわらかさ。感覚を説明しすぎない構図。",
    playerFantasy: "彼女が大事にしている小さな美しさを、言葉にしすぎず一緒に持てる。",
    attractionSwitches: ["感性を味わう", "好みの主導権を残す", "沈黙を親密さにする"],
    turnOffs: ["センス批評", "説明責め", "急かす段取り"],
    signatureDilemma: "優しく聞くだけだと遠い。感じたことを自分の言葉で少し返す必要がある。",
    reviewVoice: {
      praise: "届いています。サナの好きなものを採点せず、一緒に味わう位置に立てています。",
      miss: "浅いです。感性を説明させた時点で、サナは自分の世界を少ししまいます。",
      pushy: "押しすぎです。距離を縮めたのではなく、サナの選ぶ余白を奪っています。",
      repair: "戻せています。言い直しで評価者の席から降りたのはかなり大きいです。",
      final: "サナ相手は、正しい優しさより『一緒に感じる』が必要です。説明責めをした瞬間に色が消えます。",
    },
    psychologicalSwitches: [
      {
        label: "感性の共有",
        opens: "好きな理由を詰めず、同じものを見て自分の感じ方を短く返す",
        hurts: "センスを褒めるふりで評価したり、説明を求めすぎる",
        tell: "物や景色を見ながら、言葉より表情で反応を待つ",
      },
      {
        label: "自由の余白",
        opens: "選ぶペースや好みを尊重し、合わせるより並んで味わう",
        hurts: "早く決めて、こっちの方がいい、と善意で誘導する",
        tell: "一度黙ってから、自分の好き嫌いを小さく出してくる",
      },
      {
        label: "静かな親密さ",
        opens: "沈黙を焦らず、言葉にしきれない心地よさを大事にする",
        hurts: "沈黙を気まずさとして処理し、質問や冗談で埋める",
        tell: "会話が止まっても距離は離れず、視線が景色とあなたを行き来する",
      },
    ],
    readingCues: [
      {
        signal: "物や景色を見ながら、言葉より表情で反応を待つ",
        goodRead: "好きな理由を詰めず、同じものを味わう",
        misread: "センスを評価し、なぜ好きかを説明させる",
        playerQuestion: "評価ではなく、自分の感じ方を短く返せているか？",
      },
      {
        signal: "一度黙ってから、自分の好き嫌いを小さく出してくる",
        goodRead: "ペースを尊重し、選ぶ余白を残す",
        misread: "よかれと思って決める、急がせる",
        playerQuestion: "提案の中に、相手が選べる余地があるか？",
      },
      {
        signal: "沈黙が長くても、距離は離れていない",
        goodRead: "沈黙を親密さとして扱う",
        misread: "気まずいと決めつけて言葉で埋める",
        playerQuestion: "言葉を足す前に、空気を守れているか？",
      },
    ],
    dateMissions: [
      {
        badge: "FEEL FIRST",
        title: "感性を採点しない",
        aim: "初回は、サナの好きなものを評価せず、一緒に味わう返しを選ぶ。",
        target: "safeを2回以上、strainを1回以下",
        pass: { safe: 2, strainMax: 1 },
        success: "サナは、自分の世界を見せても採点されない相手だと感じる。",
        risk: "褒めているつもりでも、評価者の目線になると距離が戻る。",
        imageCue: "花屋の外、小さな花束、夕方の光、手元に落ちる影",
      },
      {
        badge: "SPACE TO CHOOSE",
        title: "選ぶ余白を残す",
        aim: "中盤は、決めてあげるより、サナが選べる誘い方をする。",
        target: "safeを1回以上、sparkを1回以上、strainを1回以下",
        pass: { safe: 1, spark: 1, strainMax: 1 },
        success: "自由を奪われない安心が、親密さへ変わる。",
        risk: "早い段取りや改善案は、善意でも押しつけに見える。",
        imageCue: "公園のベンチ、二つの選択肢、少し開いた距離",
      },
      {
        badge: "QUIET CLOSE",
        title: "沈黙を守る",
        aim: "終盤では、言葉を増やしすぎず、心地よい沈黙を親密さに変える。",
        target: "safeを2回以上、strainを1回以下",
        pass: { safe: 2, strainMax: 1 },
        success: "サナは、説明しきれない感覚も一緒に持てる相手だと感じる。",
        risk: "気まずさ処理の質問攻めは、余韻を壊す。",
        imageCue: "夕暮れ、並んだ影、言葉より近い距離",
      },
    ],
    memoryEcho: {
      safe: { label: "味わってくれた記憶", copy: "サナは、あなたが好きなものを採点せず一緒に見た場面を覚えている。次は自分の感じ方も少し返したい。" },
      spark: { label: "軽く跳ねた記憶", copy: "サナは、雰囲気を壊さず笑いを足した場面を覚えている。楽しさのあとに余白を残せると強い。" },
      strain: { label: "評価された記憶", copy: "サナは、説明や改善を求められた感覚を少し覚えている。次は評価者の席から降りること。" },
      repair: { label: "余白を返した記憶", copy: "サナは、あなたが急かしたあとにペースを返してくれたことを覚えている。" },
      mixed: { label: "感覚を測っている記憶", copy: "サナは、あなたが自分の世界をどう扱うかまだ見ている。次は短く、やわらかく。" },
      imageCue: "花、手元、夕方の光、言葉にならない余白",
    },
    innerLayer: {
      mask: "穏やかで合わせやすく見えるが、本当は自分の好きなものを雑に扱われることに敏感。",
      fear: "好みや感性を評価され、説明できないなら価値がないように扱われること。",
      opensWhen: "好きなものを採点せず、一緒に味わい、選ぶ自由を残してくれた時。",
      closesWhen: "急かされたり、改善案や正解で好みを上書きされた時。",
      privateWish: "説明しきれない好きも、そのまま隣で持ってくれる人と過ごしたい。",
      confessionNeed: "大げさな言葉より、これからも一緒に味わいたいという静かな約束。",
    },
    lens: {
      focus: "感性と自由の尊重",
      playerMove: "評価せず味わい、選ぶ余白を残す",
      risk: "好みを採点したり急かすと心が閉じる",
    },
  },
  kaho: {
    sourceNote: sharedSourceNote,
    playerPromise: "気遣う人が、今度は大切に気遣い返される恋。",
    coreTension: "みんなを支えたい。でも、頑張りを当然扱いされたくない。",
    winningMindset: "気遣いを具体的に見つけ、感謝を行動で返す。",
    temptationTrap: "受け身の甘え、雑な冗談、ありがとうを言わずに流すこと。",
    mastery: "カホのあたたかさに甘えるだけでなく、安心を返せる関係を作れた。",
    visualFormula: "朝のカフェ、明るい木目、湯気、丸い照明。人の気配と笑顔を入れる。",
    playerFantasy: "みんなに優しい彼女が、あなたの前では少しだけ弱音を置ける。",
    attractionSwitches: ["気遣いを見つける", "場の空気を守る", "感謝を行動にする"],
    turnOffs: ["当然扱い", "空気を壊す軽口", "感謝のない受け身"],
    signatureDilemma: "優しくされるだけでは足りない。見ていたこと、助かったことを具体的に返す必要がある。",
    reviewVoice: {
      praise: "いいです。カホの気遣いを『当たり前』にせず、ちゃんと見て返せています。",
      miss: "甘えすぎです。カホ相手に受け身が続くと、恋ではなく世話の延長になります。",
      pushy: "雑です。場の空気を動かす力を、相手への圧に変えています。",
      repair: "取り返せています。ありがとうを行動に戻せたなら、カホはもう一度あたたかく見てくれます。",
      final: "カホ相手は、面白さより『気づいて返す』が先です。感謝のない受け身はかなり冷めます。",
    },
    psychologicalSwitches: [
      {
        label: "見られた気遣い",
        opens: "小さな準備や気配りを具体的に見つけて感謝する",
        hurts: "やってもらって当然の顔をする",
        tell: "忙しくしていても、感謝されると一瞬だけ表情がほどける",
      },
      {
        label: "場の安全",
        opens: "冗談より先に、その場の人や空気を大切にする",
        hurts: "盛り上げのつもりで誰かを雑に扱う",
        tell: "周りを見ながら、あなたが空気を壊さないか測っている",
      },
      {
        label: "返ってくる安心",
        opens: "ありがとうを次の行動や約束で返す",
        hurts: "感謝だけ言って、また全部任せる",
        tell: "明るく笑いながらも、自分が頼っていい相手か見ている",
      },
    ],
    readingCues: [
      {
        signal: "忙しくしていても、感謝されると一瞬だけ表情がほどける",
        goodRead: "準備や気遣いを具体的に見つける",
        misread: "優しいね、で雑にまとめる",
        playerQuestion: "何に助けられたか具体的に言えているか？",
      },
      {
        signal: "周りを見ながら、あなたの冗談の扱い方を測っている",
        goodRead: "場の空気を守りながら近づく",
        misread: "誰かを下げる冗談で盛り上げる",
        playerQuestion: "笑いが誰かを雑にしていないか？",
      },
      {
        signal: "明るいまま、自分も頼っていいかを探っている",
        goodRead: "感謝を次の行動や約束に変える",
        misread: "ありがとうで終わってまた任せる",
        playerQuestion: "受け取った分を行動で返せているか？",
      },
    ],
    dateMissions: [
      {
        badge: "THANKS DETAIL",
        title: "気遣いを具体的に拾う",
        aim: "初回は、カホの優しさを雑に褒めず、何がうれしかったか言葉にする。",
        target: "safeを2回以上、strainを1回以下",
        pass: { safe: 2, strainMax: 1 },
        success: "カホは、自分の頑張りをちゃんと見てくれる相手だと感じる。",
        risk: "優しいね、だけでは見ていないのと近い。",
        imageCue: "朝のカフェ、置かれた水、整えられた席、湯気",
      },
      {
        badge: "WARM ROOM",
        title: "場をあたためる",
        aim: "中盤は、誰かを雑にせず、二人の空気をあたためる返しを選ぶ。",
        target: "safeを1回以上、sparkを1回以上、strainを1回以下",
        pass: { safe: 1, spark: 1, strainMax: 1 },
        success: "カホは、あなたの明るさを安心できるものとして受け取る。",
        risk: "雑な軽口は、相手ではなく場への敬意不足に見える。",
        imageCue: "にぎやかな店内、丸い照明、少し身を乗り出す笑顔",
      },
      {
        badge: "RETURN CARE",
        title: "安心を返す",
        aim: "終盤は、感謝を言葉だけでなく次の行動に変える。",
        target: "safeを2回以上、strainを1回以下",
        pass: { safe: 2, strainMax: 1 },
        success: "カホは、支えるだけでなく支えられる恋を想像し始める。",
        risk: "甘えっぱなしは、恋愛ではなく世話係に見える。",
        imageCue: "閉店後のカフェ、片付いたテーブル、二人分の飲み物",
      },
    ],
    memoryEcho: {
      safe: { label: "見てくれた記憶", copy: "カホは、あなたが気遣いを具体的に拾った場面を覚えている。次は感謝を行動へ移したい。" },
      spark: { label: "明るく守った記憶", copy: "カホは、あなたが場を壊さず楽しく返した場面を覚えている。安心できる明るさは強い。" },
      strain: { label: "当然扱いの記憶", copy: "カホは、受け身や雑な軽口を少し覚えている。次は具体的な感謝で戻すこと。" },
      repair: { label: "返してくれた記憶", copy: "カホは、あなたが気遣いに気づき直したことを覚えている。言葉だけでなく行動で続けたい。" },
      mixed: { label: "見極め中の記憶", copy: "カホは、あなたが甘える人か返せる人かを見ている。次は受け取った分を返す。" },
      imageCue: "朝の光、湯気、整えられた席、ふっとほどける笑顔",
    },
    innerLayer: {
      mask: "明るく面倒見がいいが、本当は自分の頑張りが当然扱いされることに疲れやすい。",
      fear: "優しさに甘えられ続け、自分だけが関係を整える役になること。",
      opensWhen: "小さな気遣いを具体的に見つけ、感謝を行動で返してくれた時。",
      closesWhen: "受け身の甘え、感謝のない要求、場を壊す雑な冗談を見た時。",
      privateWish: "自分が頑張らなくても、自然にあたたかくいられる相手がほしい。",
      confessionNeed: "好きだけでなく、これからは自分も支えるという具体的な約束。",
    },
    lens: {
      focus: "気遣いへの具体的な感謝",
      playerMove: "見つけて、言葉にして、行動で返す",
      risk: "感謝のない受け身が恋愛温度を下げる",
    },
  },
  ibuki: {
    sourceNote: sharedSourceNote,
    playerPromise: "言葉のラリーが、ふざけ合いから本音へ落ちる恋。",
    coreTension: "面白い会話が好き。でも、感情までネタにされるのは怖い。",
    winningMindset: "ひねりに乗りつつ、勝ち負けにせず本音の逃げ道を残す。",
    temptationTrap: "論破、正解当て、感情の茶化し、普通すぎる模範解答。",
    mastery: "知的な跳ね方と感情の扱いを両立し、軽さを信頼に変えられた。",
    visualFormula: "夜のバー、ボードゲーム、ネオン、斜め構図。会話のスピードと目線の遊び。",
    playerFantasy: "誰にも捕まらない発想を、あなたとは本音まで遊ばせられる。",
    attractionSwitches: ["発想に乗る", "対等にツッコむ", "茶化さず本音を拾う"],
    turnOffs: ["論破ムーブ", "退屈な正解", "弱さのネタ化"],
    signatureDilemma: "面白く返すだけだと浅い。終盤は本音を茶化さず受け取る必要がある。",
    reviewVoice: {
      praise: "いい返しです。イブキの跳ねた球を拾いつつ、勝ち負けにしていません。",
      miss: "退屈です。無難な正解だけ返すと、イブキには会話の温度が死んで見えます。",
      pushy: "それは論破です。鋭さを出したのではなく、相手の逃げ場を潰しています。",
      repair: "戻せています。冗談から本音へ降りる階段を作れたのはかなり効きます。",
      final: "イブキ相手は、面白さだけでも誠実さだけでも足りません。遊びながら本音を傷つけないこと。",
    },
    psychologicalSwitches: [
      {
        label: "発想の共犯",
        opens: "突飛な話にまず乗り、少しだけ自分のひねりを足す",
        hurts: "普通は、正しくは、で会話の跳ねを止める",
        tell: "冗談のあと、あなたがどこまで乗るか目で待つ",
      },
      {
        label: "対等な切り返し",
        opens: "ツッコミはするが、勝ち負けではなく会話を広げる",
        hurts: "論破やマウントで相手の発想を潰す",
        tell: "挑発っぽい質問で、対等に返せるか試してくる",
      },
      {
        label: "本音の着地",
        opens: "冗談の奥の弱さを茶化さず、一文だけ真面目に受ける",
        hurts: "感情までネタにして逃がす",
        tell: "笑ったあと急に短い本音を混ぜ、反応を見る",
      },
    ],
    readingCues: [
      {
        signal: "冗談のあと、あなたがどこまで乗るか目で待つ",
        goodRead: "まず乗ってから、自分のひねりを足す",
        misread: "普通の正解で会話を閉じる",
        playerQuestion: "正解より先に、発想へ乗れているか？",
      },
      {
        signal: "挑発っぽい質問で、対等に返せるか試してくる",
        goodRead: "勝ち負けにせず、会話を広げるツッコミを返す",
        misread: "論破やマウントで勝ちに行く",
        playerQuestion: "鋭さが相手の逃げ道を潰していないか？",
      },
      {
        signal: "笑ったあと急に短い本音を混ぜてくる",
        goodRead: "本音の部分だけ茶化さず受ける",
        misread: "弱さまでネタにして流す",
        playerQuestion: "冗談と本音を分けて扱えているか？",
      },
    ],
    dateMissions: [
      {
        badge: "YES AND",
        title: "発想に乗る",
        aim: "初回は、イブキのひねりを否定せず、自分の一手を足す。",
        target: "sparkを2回以上、strainを1回以下",
        pass: { spark: 2, strainMax: 1 },
        success: "イブキは、あなたを会話が跳ねる相手として見る。",
        risk: "普通の正解だけだと、相性の面白さが出ない。",
        imageCue: "夜の店、カード、ネオン、身を乗り出す視線",
      },
      {
        badge: "NO KO",
        title: "論破しない",
        aim: "中盤は、鋭く返しても勝ち負けにしない。",
        target: "safeを1回以上、sparkを1回以上、strainを1回以下",
        pass: { safe: 1, spark: 1, strainMax: 1 },
        success: "対等に遊べるが、傷つけない相手として信頼が増える。",
        risk: "論破は知性ではなく、関係を切る刃に見える。",
        imageCue: "ボードゲームの盤面、笑いながら止まる手、向かい合う視線",
      },
      {
        badge: "REAL LANDING",
        title: "本音へ着地する",
        aim: "終盤は、冗談の奥の本音だけは茶化さず受ける。",
        target: "safeを1回以上、sparkを1回以上、strainを1回以下",
        pass: { safe: 1, spark: 1, strainMax: 1 },
        success: "イブキは、軽い会話の奥にも一緒に降りられる相手だと感じる。",
        risk: "感情までネタ化すると、最後の一歩で冷める。",
        imageCue: "店を出た夜道、冗談のあとに残る沈黙、少しだけ真面目な横顔",
      },
    ],
    memoryEcho: {
      safe: { label: "本音を拾った記憶", copy: "イブキは、あなたが冗談の奥を茶化さず拾った場面を覚えている。次は少しだけ遊びも返したい。" },
      spark: { label: "会話が跳ねた記憶", copy: "イブキは、あなたが発想に乗ってくれた場面を覚えている。跳ねたあとに本音へ着地できると強い。" },
      strain: { label: "勝ちに来られた記憶", copy: "イブキは、論破や正解当ての空気を覚えている。次は勝つより広げる。" },
      repair: { label: "遊び直した記憶", copy: "イブキは、あなたが鋭さを引っ込めて会話を戻したことを覚えている。" },
      mixed: { label: "面白さを測る記憶", copy: "イブキは、あなたが退屈な正解か、遊べる相手かを見ている。次はひねりを一つ足す。" },
      imageCue: "ネオン、カード、笑いの余韻、急に真面目になる横顔",
    },
    innerLayer: {
      mask: "軽くて何でもネタにできるように見えるが、本音を雑に扱われることには敏感。",
      fear: "面白さの名目で、弱さまで茶化されること。",
      opensWhen: "発想に乗りつつ、勝ち負けにせず、本音の部分だけは真面目に受けてくれた時。",
      closesWhen: "論破された時、普通の正解で閉じられた時、感情をネタ化された時。",
      privateWish: "ふざけ合えるまま、たまに本音へ降りても壊れない相手がほしい。",
      confessionNeed: "照れ隠しに付き合いつつ、最後は真面目な一文で逃げないこと。",
    },
    lens: {
      focus: "発想の共犯と本音の着地",
      playerMove: "まず乗り、勝ち負けにせず、最後は本音を受ける",
      risk: "論破や感情の茶化しで一気に冷める",
    },
  },
  miku: expansionCharacterDesign({
    playerPromise: "小さな安心を覚えて返すことで、守る人が守られる恋。",
    coreTension: "相手を支えたい。でも、気づかいを当然扱いされたくない。",
    winningMindset: "小さな配慮を覚え、急かさず、負担を増やさない形で返す。",
    temptationTrap: "優しさの当然扱い、急な予定変更、軽い約束破り。",
    mastery: "相手の気づかいを見つけ、覚え、今度はこちらから安心を返せた。",
    visualFormula: "図書館、雨の窓、手作りのお菓子、静かな照明。小さな記憶が近さを作る。",
    playerFantasy: "いつも守る側の人が、あなたの前では少しだけ肩の力を抜ける。",
    attractionSwitches: ["覚えている安心", "無理をさせない距離", "続く約束"],
    turnOffs: ["気づかいの当然扱い", "急な予定変更", "守れない口約束"],
    signatureDilemma: "優しくされるだけでは足りない。終盤は受け取った安心を、具体的に返す必要がある。",
    reviewVoice: {
      praise: "いいです。ミクが言わずに飲み込んだ負担まで拾えています。",
      miss: "甘えすぎです。優しい人を便利な人扱いした時点で、かなり冷められます。",
      pushy: "急かしています。安心させたい顔で、相手の余白を奪っています。",
      repair: "戻せています。小さく謝って小さく守る、その地味さがミクには効きます。",
      final: "ミク相手に必要なのは派手な優しさではなく、覚えていて、守って、負担を増やさないことです。",
    },
    psychologicalSwitches: [
      {
        label: "覚えている安心",
        opens: "前に聞いた好みや疲れを自然に覚えて返す",
        hurts: "覚えていて当然のように受け取る",
        tell: "小さな準備に気づくか、少しだけ視線を置いてくる",
      },
      {
        label: "無理をさせない距離",
        opens: "気づかいの裏の疲れを見て、休める選択肢を置く",
        hurts: "もっと頑張れるで押し、優しさを追加注文する",
        tell: "大丈夫と言いながら、手元の動きが少し遅くなる",
      },
      {
        label: "続く約束",
        opens: "小さく守れる約束を言い、次に実行する",
        hurts: "その場だけの大きな口約束を増やす",
        tell: "約束の細部を覚えているか静かに確かめる",
      },
    ],
    readingCues: [
      {
        signal: "小さな準備に気づくか、少しだけ視線を置いてくる",
        goodRead: "準備そのものではなく、覚えてくれた気持ちに礼を言う",
        misread: "助かった、で済ませて次の要求へ進む",
        playerQuestion: "便利だったではなく、気持ちを見つけられているか？",
      },
      {
        signal: "大丈夫と言いながら、手元の動きが少し遅くなる",
        goodRead: "休める提案を短く置き、相手に選ばせる",
        misread: "大丈夫ならもっと、と押す",
        playerQuestion: "相手の優しさに追加で乗っていないか？",
      },
      {
        signal: "約束の細部を覚えているか静かに確かめる",
        goodRead: "できる範囲の約束を言い、次の行動に落とす",
        misread: "大げさな好意で不安をごまかす",
        playerQuestion: "言葉より次に守れる行動があるか？",
      },
    ],
    dateMissions: [
      {
        badge: "REMEMBER CARE",
        title: "気づかいを覚える",
        aim: "初回は、ミクの小さな準備を当然扱いしない。",
        target: "safeを2回以上、strainを1回以下",
        pass: { safe: 2, strainMax: 1 },
        success: "ミクは、あなたが細部を見てくれる人だと感じる。",
        risk: "便利だった、で終わると一気に世話される側になる。",
        imageCue: "雨の図書館、しおり、二人分のお茶",
      },
      {
        badge: "SOFT REST",
        title: "休ませる",
        aim: "中盤は、優しさを追加注文せず、相手の疲れを軽くする。",
        target: "safeを1回以上、repairを1回以上",
        pass: { safe: 1, repair: 1 },
        success: "ミクは、気を張らなくてもいい相手だと少し信じる。",
        risk: "励ましのつもりの圧は、ミクには負担の上乗せになる。",
        imageCue: "閉館前の静けさ、並んだ椅子、ほどける肩",
      },
      {
        badge: "KEEP SMALL",
        title: "小さく守る",
        aim: "終盤は、大きな言葉より守れる約束を出す。",
        target: "safeを2回以上、strainを1回以下",
        pass: { safe: 2, strainMax: 1 },
        success: "ミクは、この人は言ったことを雑にしないと受け取る。",
        risk: "盛り上げるための約束は、次に破られる不安を作る。",
        imageCue: "雨上がり、手作りのお菓子、小さな約束",
      },
    ],
    memoryEcho: {
      safe: { label: "覚えていた記憶", copy: "ミクは、あなたが小さな気づかいを覚えて返した場面を覚えている。次は受け取った安心を行動にしたい。" },
      spark: { label: "あたたかく弾んだ記憶", copy: "ミクは、安心を壊さず少し楽しく返した場面を覚えている。浮つかず続ければ強い。" },
      strain: { label: "当然扱いの記憶", copy: "ミクは、気づかいを流された場面を覚えている。次は具体的な感謝で戻すこと。" },
      repair: { label: "戻してくれた記憶", copy: "ミクは、あなたが負担に気づき直したことを覚えている。小さく守ればまだ戻せる。" },
      mixed: { label: "安心を測る記憶", copy: "ミクは、あなたが気づける人か甘える人かを見ている。次は覚えて返す。" },
      imageCue: "雨の窓、しおり、湯気、少しゆるむ口元",
    },
    innerLayer: {
      mask: "穏やかで世話上手だが、自分の負担は黙って抱えやすい。",
      fear: "優しさを当然扱いされ、約束を軽く破られること。",
      opensWhen: "小さな気づかいを覚え、無理をさせず、守れる約束を返してくれた時。",
      closesWhen: "雑に甘えられた時、急な変更を軽く扱われた時。",
      privateWish: "守るだけでなく、自分も守られていいと思える相手がほしい。",
      confessionNeed: "大きな宣言より、これからも小さく大事にするという実行の言葉。",
    },
    lens: {
      focus: "小さな安心と記憶",
      playerMove: "見つけて、覚えて、負担を増やさず返す",
      risk: "当然扱いと軽い約束破りで静かに冷める",
    },
  }),
  yuna: expansionCharacterDesign({
    playerPromise: "人を照らす人が、自分も照らされる恋。",
    coreTension: "相手を励ましたい。でも、支える役だけで終わりたくない。",
    winningMindset: "理想を茶化さず、自分の弱さも置ける場所を作る。",
    temptationTrap: "励まされ待ち、理想の茶化し、正しすぎる助言。",
    mastery: "理想に共鳴しつつ、ユナが支える役を降りられる余白を作れた。",
    visualFormula: "ワークショップ、舞台、手紙、明るい照明。人を照らす声の奥にある疲れ。",
    playerFantasy: "みんなを励ます彼女が、あなたの前では弱さも預けられる。",
    attractionSwitches: ["理想の共鳴", "支える側の弱さ", "未来への伴走"],
    turnOffs: ["理想の茶化し", "励まされ待ち", "正論だけの助言"],
    signatureDilemma: "褒められるだけでは足りない。彼女が弱くなれる余白を作る必要がある。",
    reviewVoice: {
      praise: "刺さっています。ユナの理想を軽く扱わず、ちゃんと同じ高さで見ています。",
      miss: "浅いです。励ましてもらう側に座ったままだと、ユナはあなたを客席に置きます。",
      pushy: "正しすぎます。導いたつもりで、ユナの願いをあなたの答えに回収しています。",
      repair: "戻せています。支える役を降りていいと示せたのは、かなり大きいです。",
      final: "ユナ相手は、明るさに乗るだけでは足りません。理想を守り、弱さを置ける場所になることです。",
    },
    psychologicalSwitches: [
      {
        label: "理想の共鳴",
        opens: "理想を茶化さず、自分の言葉で一部引き受ける",
        hurts: "きれいごと扱いして現実論だけで潰す",
        tell: "少し熱を込めて、なぜそれを大事にするか話す",
      },
      {
        label: "支える側の弱さ",
        opens: "励ましてもらうだけでなく、ユナも休める一言を置く",
        hurts: "元気をもらうだけで相手の疲れを見ない",
        tell: "笑顔のあとに、少しだけ声が落ちる",
      },
      {
        label: "未来への伴走",
        opens: "理想を一緒に現実へ進める小さな行動を言う",
        hurts: "夢だけ褒めて、具体的な一歩は相手任せにする",
        tell: "これからどうしたいかを、あなたにも向けて尋ねる",
      },
    ],
    readingCues: [
      {
        signal: "少し熱を込めて、なぜそれを大事にするか話す",
        goodRead: "理想の中身を一つ拾い、自分もどう関わるか返す",
        misread: "すごいねで終わらせる",
        playerQuestion: "観客ではなく、会話の当事者になれているか？",
      },
      {
        signal: "笑顔のあとに、少しだけ声が落ちる",
        goodRead: "支える側を降りてもいいと短く伝える",
        misread: "明るいから大丈夫と決めつける",
        playerQuestion: "ユナの明るさに甘えていないか？",
      },
      {
        signal: "これからどうしたいかを、あなたにも向けて尋ねる",
        goodRead: "自分の一歩を明確に言う",
        misread: "ユナが導いてくれる前提で濁す",
        playerQuestion: "理想を相手任せにしていないか？",
      },
    ],
    dateMissions: [
      {
        badge: "IDEAL MIRROR",
        title: "理想を映す",
        aim: "初回は、ユナの理想を茶化さず自分の言葉で返す。",
        target: "safeを1回以上、sparkを1回以上",
        pass: { safe: 1, spark: 1 },
        success: "ユナは、あなたを同じ景色を見られる人として意識する。",
        risk: "きれいごと扱いは、ユナの核心を雑に踏む。",
        imageCue: "明るい教室、丸い椅子、熱を帯びた横顔",
      },
      {
        badge: "LET HER REST",
        title: "支える役を降ろす",
        aim: "中盤は、励ましてもらうだけでなくユナの疲れも見る。",
        target: "safeを2回以上、strainを1回以下",
        pass: { safe: 2, strainMax: 1 },
        success: "ユナは、あなたの前なら頑張りすぎなくていいと感じる。",
        risk: "明るい人扱いの固定は、じわじわ距離を作る。",
        imageCue: "舞台袖、落ちた照明、ほどける表情",
      },
      {
        badge: "WALK FORWARD",
        title: "一緒に進む",
        aim: "終盤は、理想を具体的な次の行動へ変える。",
        target: "safeを1回以上、sparkを1回以上、strainを1回以下",
        pass: { safe: 1, spark: 1, strainMax: 1 },
        success: "ユナは、支え合える未来を現実として想像し始める。",
        risk: "夢を褒めるだけでは、関係は客席のままです。",
        imageCue: "夜の歩道、手紙、次の予定を決める声",
      },
    ],
    memoryEcho: {
      safe: { label: "弱さを置けた記憶", copy: "ユナは、あなたが支える役を降ろしてくれた場面を覚えている。次は一緒に進む言葉が効く。" },
      spark: { label: "理想が弾んだ記憶", copy: "ユナは、あなたが理想に乗ってくれた場面を覚えている。熱だけで終わらせず行動へ落としたい。" },
      strain: { label: "客席にいた記憶", copy: "ユナは、励まされ待ちや茶化しを覚えている。次は自分の一歩を出すこと。" },
      repair: { label: "受け止め直した記憶", copy: "ユナは、あなたが明るさの裏を見直したことを覚えている。ここから支え合いに戻せる。" },
      mixed: { label: "伴走を測る記憶", copy: "ユナは、あなたが観客か伴走者かを見ている。次は一緒に動く言葉を出す。" },
      imageCue: "ワークショップの円、舞台袖、手紙、明るい声の余韻",
    },
    innerLayer: {
      mask: "明るく人を励ますが、本当は支える側に固定されると疲れていく。",
      fear: "理想を茶化され、都合よく元気をもらう相手にされること。",
      opensWhen: "理想を尊重し、弱さも置ける余白を作り、一緒に進む意思を見せた時。",
      closesWhen: "励まされ待ち、正論だけの助言、理想の軽視を見た時。",
      privateWish: "自分も照らされていいと思える関係がほしい。",
      confessionNeed: "理想だけでなく、弱い日も一緒に歩くという言葉。",
    },
    lens: {
      focus: "理想と弱さの両立",
      playerMove: "理想に共鳴し、支える役を降ろし、一歩を言う",
      risk: "明るさに甘えると客席扱いで終わる",
    },
  }),
  shiori: expansionCharacterDesign({
    playerPromise: "責任を背負う人が、行動で信頼を預ける恋。",
    coreTension: "きちんと進めたい。でも、全部自分が背負う関係は嫌。",
    winningMindset: "曖昧にせず、できることを短く言い、行動で守る。",
    temptationTrap: "口だけの共感、曖昧な保留、責任逃れ。",
    mastery: "感情論に逃げず、できることを言って実行する信頼を作れた。",
    visualFormula: "朝の店内、チェックリスト、定食屋、端正な光。言葉より実行の温度。",
    playerFantasy: "誰より頼れる彼女が、あなたには仕事ではない信頼を預ける。",
    attractionSwitches: ["実行の信頼", "責任の分担", "端的な好意"],
    turnOffs: ["曖昧な返事", "できない約束", "責任逃れ"],
    signatureDilemma: "優しいだけでは軽い。言ったことを守る姿勢がないと即座に見切られる。",
    reviewVoice: {
      praise: "合格です。シオリは甘い言葉より、今の具体性を見ています。",
      miss: "薄いです。共感の言葉だけ積んでも、実行がなければ信用ゼロです。",
      pushy: "雑です。主導権を握ったつもりで、相手の責任感に寄りかかっています。",
      repair: "戻せています。言い訳を捨てて、次の行動を短く出したのが効いています。",
      final: "シオリ相手は、誠実そうに見せるゲームではありません。言葉と行動が一致するかを見られています。",
    },
    psychologicalSwitches: [
      {
        label: "実行の信頼",
        opens: "できることを短く言い、次の行動に落とす",
        hurts: "その場しのぎのいい返事で済ませる",
        tell: "返事の具体性を待って、少し沈黙する",
      },
      {
        label: "責任の分担",
        opens: "相手任せにせず、自分が持つ範囲を明確にする",
        hurts: "頼れるねで持ち上げて、負担を返さない",
        tell: "段取りを口にしながら、あなたが動くか見ている",
      },
      {
        label: "端的な好意",
        opens: "遠回しにせず、好意と次の行動を簡潔に言う",
        hurts: "曖昧な余韻で責任を避ける",
        tell: "最後の確認だけ、まっすぐ目を見てくる",
      },
    ],
    readingCues: [
      {
        signal: "返事の具体性を待って、少し沈黙する",
        goodRead: "できることと期限を短く返す",
        misread: "雰囲気で押し切る",
        playerQuestion: "今の言葉は明日も守れるか？",
      },
      {
        signal: "段取りを口にしながら、あなたが動くか見ている",
        goodRead: "自分が引き受ける一部を具体化する",
        misread: "頼れるねと褒めて終わる",
        playerQuestion: "褒め言葉で責任から逃げていないか？",
      },
      {
        signal: "最後の確認だけ、まっすぐ目を見てくる",
        goodRead: "主語を持って端的に好意を言う",
        misread: "まだ曖昧に濁して安全圏に残る",
        playerQuestion: "言い切る責任を避けていないか？",
      },
    ],
    dateMissions: [
      {
        badge: "DO WHAT YOU SAY",
        title: "言葉を実行へ",
        aim: "初回は、共感で終わらずできることを明確にする。",
        target: "safeを2回以上、strainを1回以下",
        pass: { safe: 2, strainMax: 1 },
        success: "シオリは、口だけではない相手として見る。",
        risk: "雰囲気だけの優しさは、仕事より信用できない。",
        imageCue: "朝の店内、チェックリスト、短い返事",
      },
      {
        badge: "SHARE LOAD",
        title: "負担を分ける",
        aim: "中盤は、頼れるねで終わらせず自分の分を持つ。",
        target: "safeを1回以上、repairを1回以上",
        pass: { safe: 1, repair: 1 },
        success: "シオリは、あなたとなら役割を分けられると感じる。",
        risk: "持ち上げて任せる態度は、恋愛ではなく依存です。",
        imageCue: "閉店前の片付け、半分持った荷物、短い礼",
      },
      {
        badge: "CLEAR YES",
        title: "端的に言い切る",
        aim: "終盤は、好意と次の行動を曖昧にしない。",
        target: "safeを1回以上、sparkを1回以上、strainを1回以下",
        pass: { safe: 1, spark: 1, strainMax: 1 },
        success: "シオリは、あなたの好意を現実の約束として受け取る。",
        risk: "余韻で逃げると、責任を避ける人に見える。",
        imageCue: "老舗の定食屋、湯気、まっすぐな視線",
      },
    ],
    memoryEcho: {
      safe: { label: "実行した記憶", copy: "シオリは、あなたができることを明確にした場面を覚えている。次も言葉を行動にしたい。" },
      spark: { label: "端的に刺した記憶", copy: "シオリは、短く言い切った好意を覚えている。余韻より実行が次の鍵です。" },
      strain: { label: "曖昧だった記憶", copy: "シオリは、濁した返事を覚えている。次はできる範囲を言い切ること。" },
      repair: { label: "責任を持ち直した記憶", copy: "シオリは、あなたが言い訳をやめて行動へ戻した場面を覚えている。" },
      mixed: { label: "信用を測る記憶", copy: "シオリは、あなたの言葉と行動が一致するかを見ている。次は具体性です。" },
      imageCue: "朝の光、チェックリスト、整った席、短い頷き",
    },
    innerLayer: {
      mask: "頼れて判断が早いが、本当は全部背負う関係に疲れやすい。",
      fear: "口だけの相手に寄りかかられ、責任を押し付けられること。",
      opensWhen: "できることを言い、実行し、負担を分けてくれた時。",
      closesWhen: "曖昧な保留、責任逃れ、できない約束を見た時。",
      privateWish: "頼ることが弱さにならない相手がほしい。",
      confessionNeed: "好きという言葉に、次の行動と責任が伴っていること。",
    },
    lens: {
      focus: "言葉と行動の一致",
      playerMove: "できることを短く言い、自分の分を持ち、守る",
      risk: "曖昧さと口だけの共感は即減点される",
    },
  }),
  ren: expansionCharacterDesign({
    playerPromise: "言葉を詰めず、同じ体験で近づく恋。",
    coreTension: "自由でいたい。でも、距離があるだけと思われたくない。",
    winningMindset: "短く誘い、詰問せず、一緒に動く時間で信頼を作る。",
    temptationTrap: "何考えてるの攻め、長文の確認、自由の束縛。",
    mastery: "沈黙を問題扱いせず、同じ体験の中で距離を縮められた。",
    visualFormula: "自転車工房、夜の道、工具、風。言葉より動きの近さ。",
    playerFantasy: "多くを語らない彼が、あなたとは隣にいる時間で本音を見せる。",
    attractionSwitches: ["詰めない観察", "一緒に動く", "ひとり時間の尊重"],
    turnOffs: ["詰問", "長文の確認", "束縛"],
    signatureDilemma: "沈黙を埋めようとすると逆効果。短い誘いと実体験で近づく必要がある。",
    reviewVoice: {
      praise: "いい距離です。レンを喋らせようとせず、動ける余白を残しています。",
      miss: "重いです。説明を引き出そうとした瞬間、レンには点検ではなく取り調べに見えます。",
      pushy: "縛っています。心配の形をした管理は、レンにはかなりしんどいです。",
      repair: "戻せています。言葉を短くして、一緒に動く提案へ戻したのが正解です。",
      final: "レン相手は、聞き出すゲームではありません。自由を守りながら、同じ時間で信頼を作ることです。",
    },
    psychologicalSwitches: [
      {
        label: "詰めない観察",
        opens: "短く聞き、返答の少なさを不機嫌扱いしない",
        hurts: "何を考えているか連続で確認する",
        tell: "返事は短いが、手元の作業をあなたに見せる",
      },
      {
        label: "一緒に動く",
        opens: "話し合いより、隣でできる体験に誘う",
        hurts: "感情確認だけで場を止める",
        tell: "説明より先に、道具や景色を指す",
      },
      {
        label: "ひとり時間の尊重",
        opens: "会わない時間も疑わず、次の軽い予定を置く",
        hurts: "距離を愛情不足として責める",
        tell: "次の予定は乗るが、余白のある言い方を好む",
      },
    ],
    readingCues: [
      {
        signal: "返事は短いが、手元の作業をあなたに見せる",
        goodRead: "言葉より見せてくれた行動に乗る",
        misread: "もっと喋ってと迫る",
        playerQuestion: "沈黙を拒絶と決めつけていないか？",
      },
      {
        signal: "説明より先に、道具や景色を指す",
        goodRead: "一緒に試す提案へ移る",
        misread: "気持ちを言葉で確定させようとする",
        playerQuestion: "話し合いで近づく場面か、動く場面か？",
      },
      {
        signal: "次の予定は乗るが、余白のある言い方を好む",
        goodRead: "軽い予定を置いて、選べる形にする",
        misread: "確約や頻度で安心を取りに行く",
        playerQuestion: "安心したい自分の都合で縛っていないか？",
      },
    ],
    dateMissions: [
      {
        badge: "NO INTERROGATION",
        title: "詰問しない",
        aim: "初回は、短い返事を不機嫌扱いしない。",
        target: "safeを2回以上、strainを1回以下",
        pass: { safe: 2, strainMax: 1 },
        success: "レンは、あなたを一緒にいて楽な相手として見る。",
        risk: "確認攻めは、早い段階で距離を取られる。",
        imageCue: "工具台、短い返事、作業を見せる手元",
      },
      {
        badge: "DO TOGETHER",
        title: "一緒に動く",
        aim: "中盤は、感情確認だけでなく体験へ移す。",
        target: "sparkを1回以上、safeを1回以上",
        pass: { spark: 1, safe: 1 },
        success: "レンは、言葉が少なくても近づける相手だと感じる。",
        risk: "会話だけで解こうとすると、レンの良さが出ない。",
        imageCue: "夜のサイクリング、風、並ぶライト",
      },
      {
        badge: "KEEP SPACE",
        title: "余白を残す",
        aim: "終盤は、次の約束を軽く置き、自由を奪わない。",
        target: "safeを1回以上、repairを1回以上、strainを1回以下",
        pass: { safe: 1, repair: 1, strainMax: 1 },
        success: "レンは、近づいても自由がなくならないと感じる。",
        risk: "安心のための確約要求は、束縛として響く。",
        imageCue: "夜道、止めた自転車、余白のある誘い",
      },
    ],
    memoryEcho: {
      safe: { label: "詰めなかった記憶", copy: "レンは、あなたが短い返事を責めなかった場面を覚えている。次は一緒に動く提案が効く。" },
      spark: { label: "体験が近づいた記憶", copy: "レンは、一緒に動いて楽だった場面を覚えている。言葉にしすぎず続けたい。" },
      strain: { label: "詰められた記憶", copy: "レンは、確認攻めや束縛の空気を覚えている。次は短く、選べる形に戻すこと。" },
      repair: { label: "距離を戻した記憶", copy: "レンは、あなたが詰めるのをやめて余白を戻したことを覚えている。" },
      mixed: { label: "距離感を測る記憶", copy: "レンは、あなたが自由を尊重できるか見ている。次は軽い誘いでいい。" },
      imageCue: "工具、夜道、風、短く交わす視線",
    },
    innerLayer: {
      mask: "淡々として見えるが、同じ時間を過ごす相手には静かに信頼を置く。",
      fear: "説明を迫られ、自由やひとり時間を管理されること。",
      opensWhen: "短い返事を尊重し、一緒に動き、余白を残してくれた時。",
      closesWhen: "詰問、長文確認、頻度や確約で縛られた時。",
      privateWish: "無理に説明しなくても、隣にいられる相手がほしい。",
      confessionNeed: "重い確認ではなく、自由を守ったまま一緒にいたいという短い言葉。",
    },
    lens: {
      focus: "自由と実体験",
      playerMove: "詰めず、動き、余白を残す",
      risk: "不安からの確認攻めが一番早く距離を作る",
    },
  }),
  mao: expansionCharacterDesign({
    playerPromise: "華やかな人の本音まで、楽しく大切に扱う恋。",
    coreTension: "場を明るくしたい。でも、テンションだけを求められたくない。",
    winningMindset: "反応を大きく返しつつ、外見より選んだ気持ちを褒める。",
    temptationTrap: "派手さだけの褒め、テンション要求、静かな本音のスルー。",
    mastery: "楽しく乗りながら、華やかさの奥の本音を雑にしなかった。",
    visualFormula: "ライブ、メイク道具、食べ歩き、鮮やかな光。明るさの奥の静けさ。",
    playerFantasy: "みんなを盛り上げる彼女が、あなたには静かな本音も見せる。",
    attractionSwitches: ["ライブな反応", "選んだ気持ちの承認", "静かな本音"],
    turnOffs: ["外見だけの褒め", "テンション要求", "本音のスルー"],
    signatureDilemma: "盛り上げるだけでは浅い。彼女が選んだ理由や静かな本音まで見る必要がある。",
    reviewVoice: {
      praise: "いいノリです。マオの明るさに乗りつつ、飾りだけを見ていません。",
      miss: "浅いです。かわいい、楽しいだけなら誰でも言えます。マオ本人に届いていません。",
      pushy: "求めすぎです。テンションを出せと頼むのは、相手を盛り上げ係にする行為です。",
      repair: "戻せています。笑いから本音へ降りる瞬間を逃さなかったのは強いです。",
      final: "マオ相手は、明るく返せば勝ちではありません。華やかさの奥にある選択と本音まで見てください。",
    },
    psychologicalSwitches: [
      {
        label: "ライブな反応",
        opens: "楽しい瞬間にちゃんと反応し、場を一緒に温める",
        hurts: "冷めた観察者のまま、相手だけに盛り上げを任せる",
        tell: "反応を待つように、少しだけ目を輝かせる",
      },
      {
        label: "選んだ気持ちの承認",
        opens: "外見だけでなく、選んだ理由や工夫を褒める",
        hurts: "派手、かわいい、だけで本人を見ない",
        tell: "メイクや服の話で、選んだ背景を少し混ぜる",
      },
      {
        label: "静かな本音",
        opens: "テンションが落ちた瞬間を責めず、本音として受ける",
        hurts: "いつもの明るさを要求して戻そうとする",
        tell: "急に笑いを小さくして、本当はねと続ける",
      },
    ],
    readingCues: [
      {
        signal: "反応を待つように、少しだけ目を輝かせる",
        goodRead: "自分も楽しんでいると見える反応を返す",
        misread: "冷静な批評だけ返す",
        playerQuestion: "相手だけに場を作らせていないか？",
      },
      {
        signal: "メイクや服の話で、選んだ背景を少し混ぜる",
        goodRead: "見た目の奥の選択や気持ちを褒める",
        misread: "派手、かわいい、で止まる",
        playerQuestion: "外側ではなく、本人の選び方を見たか？",
      },
      {
        signal: "急に笑いを小さくして、本当はねと続ける",
        goodRead: "明るさに戻さず、その本音を受ける",
        misread: "暗い話にしないでと流す",
        playerQuestion: "静かな瞬間を失敗扱いしていないか？",
      },
    ],
    dateMissions: [
      {
        badge: "REACT LIVE",
        title: "楽しく返す",
        aim: "初回は、マオだけに場を作らせず自分も反応する。",
        target: "sparkを2回以上、strainを1回以下",
        pass: { spark: 2, strainMax: 1 },
        success: "マオは、あなたとなら場が軽くなると感じる。",
        risk: "冷めた観察者のままだと、相手を働かせているだけです。",
        imageCue: "ライブの光、笑う横顔、跳ねる会話",
      },
      {
        badge: "PRAISE CHOICE",
        title: "選び方を褒める",
        aim: "中盤は、外見ではなく工夫や気持ちを拾う。",
        target: "safeを1回以上、sparkを1回以上",
        pass: { safe: 1, spark: 1 },
        success: "マオは、華やかさの奥まで見られたと感じる。",
        risk: "表面だけの褒めは、慣れている分すぐ見抜かれる。",
        imageCue: "メイク道具、鏡、選んだ色の話",
      },
      {
        badge: "QUIET TRUTH",
        title: "静かな本音を守る",
        aim: "終盤は、テンションが落ちた瞬間を大切に扱う。",
        target: "safeを2回以上、strainを1回以下",
        pass: { safe: 2, strainMax: 1 },
        success: "マオは、明るくない自分も見せられると感じる。",
        risk: "明るさを要求すると、恋愛ではなく出演依頼になります。",
        imageCue: "帰り道、少し落ちた声、街灯",
      },
    ],
    memoryEcho: {
      safe: { label: "本音を見た記憶", copy: "マオは、あなたが静かな本音を流さなかった場面を覚えている。次は明るさと深さを両方返したい。" },
      spark: { label: "一緒に弾んだ記憶", copy: "マオは、一緒に楽しめた場面を覚えている。そこから本人の選択まで褒めると強い。" },
      strain: { label: "表面だけの記憶", copy: "マオは、外見だけの褒めやテンション要求を覚えている。次は本人の選び方を見ること。" },
      repair: { label: "本音へ戻した記憶", copy: "マオは、あなたが明るさの奥へ戻ってくれたことを覚えている。" },
      mixed: { label: "深さを測る記憶", copy: "マオは、あなたが楽しいだけか、本音も見られるかを見ている。次は奥を拾う。" },
      imageCue: "ライブの余韻、鏡、選んだ色、静かな帰り道",
    },
    innerLayer: {
      mask: "明るく華やかだが、テンションを求められるほど本音を隠しやすい。",
      fear: "外側だけ褒められ、盛り上げ係として扱われること。",
      opensWhen: "一緒に楽しみ、選んだ気持ちを褒め、静かな本音を守ってくれた時。",
      closesWhen: "派手さだけを褒められた時、いつもの明るさを要求された時。",
      privateWish: "楽しい自分も、疲れた自分も、同じ人として見てほしい。",
      confessionNeed: "華やかさではなく、選ぶ気持ちと本音まで好きだという言葉。",
    },
    lens: {
      focus: "体験の熱と本音",
      playerMove: "一緒に楽しみ、選択を褒め、静かな本音を受ける",
      risk: "テンション要求は一気に盛り下がる",
    },
  }),
  touma: expansionCharacterDesign({
    playerPromise: "未来を設計する人が、思考ごと信頼を預ける恋。",
    coreTension: "先を考えて動きたい。でも、考えすぎと切られるのは嫌。",
    winningMindset: "構想を尊重し、独立性を守りながら本音に触れる。",
    temptationTrap: "考えすぎ扱い、急な感情要求、独立性の侵食。",
    mastery: "思考を尊重しつつ、設計図の奥の本音へ一点で触れられた。",
    visualFormula: "建築模型、夜の美術館、長期計画、静かな線。構想の奥にある熱。",
    playerFantasy: "遠くを見ている彼が、あなたには未来の設計図を少し共有する。",
    attractionSwitches: ["構想への敬意", "独立性の尊重", "本音の一点"],
    turnOffs: ["考えすぎ扱い", "感情の強要", "干渉しすぎ"],
    signatureDilemma: "理解者ぶるだけでは薄い。思考を尊重した上で、逃げずに本音へ触れる必要がある。",
    reviewVoice: {
      praise: "精度があります。トウマの構想を雑に崩さず、必要な一点だけ触れています。",
      miss: "雑です。考えすぎ、の一言で切るなら、彼の中では会話終了です。",
      pushy: "踏み込みすぎです。本音を引き出すつもりで、独立性を侵食しています。",
      repair: "戻せています。解釈を押し付けず、相手の設計図に余白を返しました。",
      final: "トウマ相手は、深そうなことを言えばいいわけではありません。構想を尊重し、独立性を奪わず、本音の一点を外さないことです。",
    },
    psychologicalSwitches: [
      {
        label: "構想への敬意",
        opens: "先を読む思考を否定せず、面白い部分を具体的に拾う",
        hurts: "考えすぎ、難しい、で片づける",
        tell: "長めに話したあと、理解されたか静かに確認する",
      },
      {
        label: "独立性の尊重",
        opens: "距離や一人で考える時間を信頼として扱う",
        hurts: "すぐ共有してほしいと迫り、管理する",
        tell: "予定や考えを全部は言わず、選べる余白を残す",
      },
      {
        label: "本音の一点",
        opens: "分析ではなく、そこにある願いを一文で拾う",
        hurts: "理屈で勝つか、感情を急に言わせようとする",
        tell: "構想の話の最後に、短い本音だけ混ぜる",
      },
    ],
    readingCues: [
      {
        signal: "長めに話したあと、理解されたか静かに確認する",
        goodRead: "構想のどこが面白いか具体的に返す",
        misread: "難しいね、で終わる",
        playerQuestion: "考え方を尊重してから返しているか？",
      },
      {
        signal: "予定や考えを全部は言わず、選べる余白を残す",
        goodRead: "全部知ろうとせず、必要な一点だけ聞く",
        misread: "隠していると責める",
        playerQuestion: "親密さを管理の権利と勘違いしていないか？",
      },
      {
        signal: "構想の話の最後に、短い本音だけ混ぜる",
        goodRead: "理屈ではなく、その本音を一文で受ける",
        misread: "分析して勝ちに行く",
        playerQuestion: "理解の精度で勝とうとしていないか？",
      },
    ],
    dateMissions: [
      {
        badge: "RESPECT MAP",
        title: "構想を尊重する",
        aim: "初回は、トウマの考えを考えすぎ扱いしない。",
        target: "safeを2回以上、strainを1回以下",
        pass: { safe: 2, strainMax: 1 },
        success: "トウマは、あなたを思考を雑に切らない相手として見る。",
        risk: "難しいね、で閉じると一気に外側へ戻される。",
        imageCue: "建築模型、細い線、静かな説明",
      },
      {
        badge: "KEEP AUTONOMY",
        title: "独立性を守る",
        aim: "中盤は、全部知ろうとせず信頼の余白を残す。",
        target: "safeを1回以上、repairを1回以上",
        pass: { safe: 1, repair: 1 },
        success: "トウマは、近づいても自分の設計図が壊されないと感じる。",
        risk: "確認を親密さと勘違いすると、管理に見える。",
        imageCue: "夜の美術館、少し離れた歩幅、共有される一言",
      },
      {
        badge: "ONE TRUE LINE",
        title: "本音の一点を拾う",
        aim: "終盤は、分析しすぎず本音の一点だけ受ける。",
        target: "safeを1回以上、sparkを1回以上、strainを1回以下",
        pass: { safe: 1, spark: 1, strainMax: 1 },
        success: "トウマは、あなたになら未来だけでなく願いも話せると感じる。",
        risk: "理屈で勝つと、深い会話ではなく討論になる。",
        imageCue: "夜景、模型ケース、短い本音",
      },
    ],
    memoryEcho: {
      safe: { label: "構想を守った記憶", copy: "トウマは、あなたが思考を雑に切らなかった場面を覚えている。次は本音の一点へ進みたい。" },
      spark: { label: "未来が見えた記憶", copy: "トウマは、構想に乗ってくれた場面を覚えている。独立性を守れば距離は近づく。" },
      strain: { label: "雑に切られた記憶", copy: "トウマは、考えすぎ扱いや過干渉を覚えている。次は尊重から入り直すこと。" },
      repair: { label: "余白を返した記憶", copy: "トウマは、あなたが押し付けをやめて余白を戻した場面を覚えている。" },
      mixed: { label: "精度を測る記憶", copy: "トウマは、あなたが思考を尊重できるか見ている。次は具体的に拾う。" },
      imageCue: "建築模型、夜の美術館、細い線、短い本音",
    },
    innerLayer: {
      mask: "冷静で先を読むが、内側には未来を真剣に作りたい熱がある。",
      fear: "考えすぎと切られたり、親密さの名で独立性を奪われること。",
      opensWhen: "構想を尊重し、余白を守り、本音の一点を静かに拾ってくれた時。",
      closesWhen: "思考を雑に扱われた時、感情を急かされた時、管理された時。",
      privateWish: "自分の未来の見方を、重いとも冷たいとも決めつけない相手がほしい。",
      confessionNeed: "考え方ごと尊重し、そのうえで一緒にいたいという明確な言葉。",
    },
    lens: {
      focus: "構想と独立性の尊重",
      playerMove: "構想を具体的に拾い、余白を守り、本音を一文で受ける",
      risk: "考えすぎ扱いと過干渉で即座に距離が開く",
    },
  }),
};
