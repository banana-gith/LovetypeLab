...
const characters = [
  ...
  },
  {
    ...
    roman: "SANA",
    roleName: "感性のアーティスト",
    style: "ISFP風・今を味わう感性型",
    theme: "雰囲気、好み、押しつけない親密さ",
    age: "25歳",
    job: "フローリスト",
    pace: "ゆっくり",
    difficulty: "中級",
    ...
    emoji: "✿",
    best: "empathize",
    bio: "言葉よりも、その場の空気や相手の扱い方を見ているタイプ。感性を説明させられるより、一緒に味わってくれる人に心を開く。",
    likes: ["花屋めぐり", "夕方の公園", "手触りのいい雑貨"],
    caution: "好みを評価されること。急かされること。感性を正解/不正解で裁かれること。",
  },
  {
    id: "kaho",
    type: "ESFJ",
    ...
    roman: "KAHO",
    roleName: "世話焼きな主人公",
    style: "ESFJ風・あたたかい調和型",
    theme: "気配り、感謝、みんなの中での安心",
    age: "27歳",
    job: "カフェマネージャー",
    pace: "ふつう",
    difficulty: "初級",
    ...
    emoji: "●",
    best: "empathize",
    bio: "相手をよく見て先回りできる分、自分の頑張りを当然扱いされると疲れやすい。感謝を具体的に返されると、一気に安心する。",
    likes: ["朝ごはん", "友達との集まり", "小さなサプライズ"],
    caution: "気遣いを当然扱いされること。場の空気を壊す雑な冗談。感謝のない受け身。",
  },
  {
    id: "ibuki",
    type: "ENTP",
    ...
    roman: "IBUKI",
    roleName: "知的な発明家",
    style: "ENTP風・ひねりのある会話型",
    theme: "言葉遊び、発想、対等なツッコミ",
    age: "26歳",
    job: "広告プランナー",
    pace: "はやめ",
    difficulty: "上級",
    ...
    emoji: "＊",
    best: "playful",
    bio: "会話の跳ね方で相性を見るタイプ。面白く返せる人に惹かれるが、雑に論破されたり感情を茶化されると急に冷める。",
    likes: ["深夜ラジオ", "ボードゲーム", "企画会議"],
    caution: "会話を勝ち負けにされること。ありきたりな正解。弱さを冗談で逃がされること。",
  },
  {
    id: "miku",
    type: "ISFJ",
    ...
    roman: "MIKU",
    roleName: "やさしい守護者",
    style: "ISFJ風・小さな安心を積む型",
    theme: "気づかい、記憶、ゆっくり深まる信頼",
    age: "26歳",
    job: "図書館司書",
    pace: "ゆっくり",
    difficulty: "初級",
    ...
    emoji: "◆",
    best: "empathize",
    bio: "相手の小さな変化に気づける分、自分の負担は後回しにしがち。覚えていてくれる言葉や、無理をさせない配慮に安心する。",
    likes: ["図書館", "手作りのお菓子", "静かな雨の日"],
    caution: "気づかいを当然扱いされること。急な変更や、軽い約束破り。",
  },
  {
    id: "yuna",
    type: "ENFJ",
    ...
    emoji: "✧",
    best: "empathize",
    bio: "人の良さを見つけるのが得意で、場を明るく導けるタイプ。ただし、支える側に固定されると、自分の弱さを出しにくくなる。",
    likes: ["ワークショップ", "舞台鑑賞", "手紙"],
    caution: "理想を茶化されること。励ます役だけを求められること。",
  },
  {
    id: "shiori",
    type: "ESTJ",
    ...
    roman: "SHIORI",
    roleName: "頼れる統率者",
    style: "ESTJ風・現実を動かす責任型",
    theme: "段取り、責任感、誠実な実行力",
    age: "29歳",
    job: "店舗統括",
    pace: "はやめ",
    difficulty: "上級",
    ...
    emoji: "▣",
    best: "concrete",
    bio: "言葉より行動の整合性を見ているタイプ。頼れる反面、責任を一人で背負いやすく、口だけの優しさには厳しい。",
    likes: ["朝活", "チェックリスト", "老舗の定食屋"],
    caution: "曖昧な返事。責任逃れ。できない約束を軽く言うこと。",
  },
  {
    id: "ren",
    type: "ISTP",
    ...
    roman: "REN",
    roleName: "静かな実践家",
    style: "ISTP風・距離感を大事にする実践型",
    theme: "自由、実体験、短く自然な会話",
    age: "25歳",
    job: "自転車メカニック",
    pace: "ふつう",
    difficulty: "上級",
    ...
    emoji: "◇",
    best: "action",
    bio: "多くを語らず、実際に一緒に動く時間で親しさが育つタイプ。詰問や重い確認より、自由を尊重した短い誘いが響く。",
    likes: ["工具", "夜のサイクリング", "無言で作業する時間"],
    caution: "何を考えているか詰められること。自由を束縛されること。",
  },
  {
    id: "mao",
    type: "ESFP",
    ...
    roman: "MAO",
    roleName: "場を彩る表現者",
    style: "ESFP風・今を楽しむライブ型",
    theme: "体験、褒め方、明るさの奥の本音",
    age: "24歳",
    job: "ヘアメイク",
    pace: "はやめ",
    difficulty: "中級",
    ...
    emoji: "✺",
    best: "playful",
    bio: "その場を明るくする力があり、反応が豊かな人に惹かれやすい。外側の華やかさだけ見られると、本音をしまいやすい。",
    likes: ["ライブ", "メイク道具", "食べ歩き"],
    caution: "派手さだけを褒められること。テンションを当然扱いされること。",
  },
  {
    id: "touma",
    type: "INTJ",
    ...
    emoji: "◇",
    best: "concrete",
    bio: "静かに観察し、先の構造まで考えてから動くタイプ。雑な感情論より、思考を尊重したうえで本音へ触れられると距離が近づく。",
    likes: ["建築模型", "夜の美術館", "長期計画"],
    caution: "考えすぎと片づけられること。独立性を奪われること。",
  },
];
